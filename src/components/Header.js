          ...
          <div className='row'>
            ...
            <div className='col-6'>
              <p className='text-end text-white mb-0'>
                Hotline:<a className='text-white' href='tel: +91 9995504744'>(888) 4344 6000-(888) 1338 8193</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <header className='header-upper py-3'>
        <div className='container-xxl'>
          <div className='row align-items-center'>
            <div className='col-2'>
              <h2 ><Link className='text-white'>Leetick</Link></h2>
            </div>
            <div className='col-5'>
              <div className="input-group">
                ...
                <span className="input-group-text p-3"
                  id="basic-addon2"><BsSearch className='fs-5' /></span>
              </div>
            </div>
            <div className='col-5'>
